import { createAppointment, getAppointmentsByBusiness } from "../services/firestoreService.js";

export const createAppointmentController = async (req, res) => {
  try {
    const { businessId, staffId, serviceType, date, horario, calificacion } = req.body || {};
    ...
    const code = /not found|no pertenece|fecha inválida/i.test(msg) ? 400 : (/not found/i.test(msg) ? 404 : 500);
