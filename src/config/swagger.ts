                ...
                "application/json": {
                  schema: {
                    ...
                    properties: {
                      ...
                      latitude: { type: "number", nullable: true, description: "Latitud geocodificada de la dirección" },
                      longitude: { type: "number", nullable: true, description: "Longitud geocodificada de la dirección" },
                      isInitialSetupComplete: { type: "boolean" },
                    },
                  },
                },
                      ...
                      businesses: {
                        ...
                        items: {
                          ...
                          properties: {
                            ...
                            banner: { type: "string", nullable: true },
                            name: { type: "string" },
                            latitude: { type: "number", nullable: true, description: "Latitud geocodificada" },
                            longitude: { type: "number", nullable: true, description: "Longitud geocodificada" },
                          },
                        },
                      },
                      total: { type: "number" },
