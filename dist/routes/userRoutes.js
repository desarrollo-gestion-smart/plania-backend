...
router.patch("/clients/:clientId", authenticateToken, upload.fields([
...
router.post("/configure-business", authenticateToken, authorizeRoles("business"), upload.fields([
    { name: "avatar", maxCount: 1 },
    { name: "image", maxCount: 1 }, // alias para avatar
    { name: "banner", maxCount: 1 },
    { name: "staffAvatars" }
]), configureBusiness);
router.patch("/configure-business", authenticateToken, authorizeRoles("business"), upload.fields([
    { name: "avatar", maxCount: 1 },
    { name: "image", maxCount: 1 },
    { name: "banner", maxCount: 1 },
    { name: "staffAvatars" }
