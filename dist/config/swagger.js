        ...
        paths: {
            ...
            "/appointments/{businessId}/list-client": {
                get: {
                    ...
                    description: "Agrupa clientes por cantidad de citas en el negocio: mejores (más de 3 citas), noTeVisitan (3 citas), noHanVuelto (1 o 2 citas). Todos incluye todos los clientes con al menos una cita. Cada item tiene userId, userName, userAvatar y staffdates (fecha más reciente del cliente).",
                    security: [{ bearerAuth: [] }],
            ...
            "/appointments/{appointmentId}/timer": {
                get: {
                    ...
                    description: "Sin query params: stream SSE (la petición queda abierta; ticks cada segundo). Con ?json=1: devuelve una sola respuesta JSON y cierra (recomendado para Swagger o polling).",
                    security: [{ bearerAuth: [] }],
                    parameters: [
